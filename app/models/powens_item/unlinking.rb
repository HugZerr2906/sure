module PowensItem::Unlinking
  extend ActiveSupport::Concern

  # Unlink every Powens account from its Sure account, detaching holdings and
  ...
  def unlink_all!(dry_run: false)
    ...
    powens_accounts.find_each do |provider_account|
      ...
      begin
        ...
        DebugLogEntry.capture(
          ...
          metadata: {
            powens_item_id: id,
            powens_account_id: provider_account.id,
            link_ids: link_ids,
